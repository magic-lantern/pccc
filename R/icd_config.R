...
#
#
get_code_set <- function(icd_ver = 9L) {
  if (icd_ver == 9) {
    list(
    ...
    list(
      dx_neuromusc = c("E750","E751","E752","E754","F71","F72","F73","F842","G111","G112","G114","G118",
      ...
      dx_cvd = c("I270","I271","I272","I2781","I2789","I279","I340","I348","I360","I368","I370",
      ...
      dx_respiratory = c("E84","G4753","I2782","I43","Q30","Q31","Q32","Q33","Q34","P280","Z902","J84112",
        "J9500","J9501","J9502","J9503","J9504","J9509","9620","Z430","Z930","Z942","Z990","J95850",
        "Z9911","Z9912","T86810","T86811","T86819"),

      dx_renal = c("N18","Q60","Q61","Q62","Q63","Q64","Z905","Z906","G834","N312","N319","T8571XA",
        "Z940","Z9350","Z9351","Z9352","Z9359","Z936","Z9115","Z992","Z435","Z436","Z446","Z4901",
        "Z4902","Z4931","Z4932","T8610","T8611","T8612"),

      dx_gi = c("K50","K51","K73","K74","K754","K760","K761","K762","K763","K768","Q390","Q391",
      ...
      dx_hemato_immu = c("B20", "D55","D56","D57","D58","D60","D61","D71","D720","D80","D81","D82",
      ...
      dx_metabolic = c("D841","E700","E702","E703","E704","E705","E708","E710","E711","E712","E713",
      ...
      dx_congeni_genetic = c("E343","K449","M410","M412","M4130","M418","M419","M4330","M965","Q722","Q750",
      ...
      dx_malignancy = c("C","D00","D01","D02","D03","D04","D05","D06","D07","D08","D09","D37","D38",
        "D39","D3A0","D40","D41","D42","D43","D44","D45","D46","D47","D48","D49","Q850","Z9481",
        "Z9484","T8600","T8601","T8602","T8609"),

      dx_neonatal = c("P0501","P0511","P0502","P0512","P052","P059","P0701","P0702","P0721","P0722",
      ...
      dx_tech_dep = c("T8509XA","T85190A","T85192A","T85199A","T8579XA","Z982","Z45441","Z45442","T82519A",
      ...
      dx_transplant = c("T8600","T8601","T8602","T8609","T8610","T8611","T8612","T8620","T8621","T8622",
        "T86810","T86811","T86819","T8640","T8641","T8642","T86890","T86891","T86899","T86850",
        "T86851","T86859","T865","T8690","T8691","T8692","T8699"),

      pc_neuromusc = c("0016070","0016071","0016072","0016073","0016074","0016075","0016076","0016077",
      ...
      pc_cvd = c("02170ZP","02170ZQ","02170ZR","02BK0ZZ","02H40JZ","02H40KZ","02H43JZ","02H44JZ",
      ...
      pc_respiratory = c("0B110F4","0B110Z4","0B113F4","0B113Z4","0B114F4","0B114Z4","0B21XFZ","0BHR0MZ",
      ...
      pc_renal = c("031209D","031209F","03120AD","03120AF","03120JD","03120JF","03120KD","03120KF",
      ...
      pc_gi = c("0CT70ZZ","0CT7XZZ","0D11074","0D110J4","0D110K4","0D110Z4","0D113J4","0D11474",
      ...
      pc_hemato_immu = c("07TP0ZZ","07TP4ZZ","07YP0Z0","07YP0Z1","07YP0Z2","30230AZ","30230G0","30230G1",
      ...
      pc_metabolic = c("0GT00ZZ","0GT04ZZ","0GT40ZZ","0GT44ZZ","0GTK0ZZ","0GTK4ZZ","0GTR0ZZ","0GTR4ZZ",
      ...
      pc_malignancy = c("3E00X05","3E01305","3E02305","3E03005","3E03305","3E04005","3E04305","3E05005",
      ...
      pc_tech_dep = c("00160J0","00160J1","00160J2","00160J4","00160J5","00160J6","00160J7","00160J8",
      ...
      pc_transplant = c("02YA0Z0","02YA0Z1","02YA0Z2","0BYC0Z0","0BYC0Z1","0BYC0Z2","0BYD0Z0","0BYD0Z1",

# this function needs to replace get_codes.cpp and get_codes.R
#
#
...
set_code_set <- function(icd_ver = 9L) {
  if (icd_ver == 9) {
    ...
    pkg.env$dx_cvd <- c("4161","4168","4169","4240","4258","4242","4243","4250","4251","4252","4253",
    ...
    pkg.env$dx_respiratory <- c("32725","4162","5163","51631","51884","5190","2770","748","7704","V426",
      "V440","V4576","V460","V461","V550")

    pkg.env$dx_renal <- c("34461","585","5964","59653","59654","753","99668","V420","V445","V446",
      "V451","V4573","V4574","V536","V555","V556","V56")

    pkg.env$dx_gi <- c("4530","5364","555","556","5571","5602","5647","5714","5715","5716","5717",
      "5718","5719","7503","751","V427","V4283","V4284","V441","V442","V443","V444","V5350",
      "V5351","V5359","V551","V552","V553","V554")

    pkg.env$dx_hemato_immu <- c("042","043","044","135","279","2820","2821","2822","2823","2824","2825",
      "2826","2881","2882","284","2860","2863","28732","28733","28739","28801","28802",
      "2884","4460","4461","44621","4464","4465","4466","4467","7100","7101","7103","V08")

    pkg.env$dx_metabolic <- c("243","2532","2535","2536","2539","2550","25513","2552","270","271","272",
      "2750","2751","2752","2753","2772","2773","2774","2775","2776","2778","2779",
      "V4585","V5391","V6546")

    pkg.env$dx_congeni_genetic <- c("2594","5533","7373","7560","7561","7562","7563","7564","7565","7566",
      "7567","758","7597","7598","7599")

    pkg.env$dx_malignancy <- c("14","15","16","17","18","19","20","23","V4281","V4282")

    pkg.env$dx_neonatal <- c("76401","76402","76411","76412","76421","76422","76491","76492","76501",
    ...
    pkg.env$dx_tech_dep <- c("5190","5364","9960","9961","9962","9964","99661","99662","99663","99666","99667",
    ...
    pkg.env$dx_transplant <- c("99680","99681","99682","99683","99684","99685","99686","99687","99688","99689",
      "V421","V422","V426","V427","V4281","V4282","V4283","V4284","V432","V4585","V5391")

    pkg.env$pc_neuromusc <- c("0152","0153","0221","0222","0231","0232","0233","0234","0235","0239","0241",
      "0242","0293","0371","0372","0379","0393","0397","0492")

    pkg.env$pc_cvd <- c("0050","0051","0053","0054","0055","0057","1751","1752","3581","3582","3583",
    ...
    pkg.env$pc_respiratory <- c("303","304","3121","3129","3141","3174","3241","3249","3250","3259","3321",
      "3350","3351","3352","336", "3485","9655","9723")

    pkg.env$pc_renal <- c("3895","3927","3942","3993","3994","3995","5498","5502","5503","5504","5512",
    ...
    pkg.env$pc_gi <- c("253","254","4210","4211","4242","4281","4311","4319","4391","4399","4412",
    ...
    pkg.env$pc_hemato_immu <- c("4100","4101","4102","4103","4104","4105","4106","4107","4108","4109","415",
      "4194")

    pkg.env$pc_metabolic <- c("064","0652","0681","073","0764","0765","0768","0769","624","6241","645","6551",
      "6553","6561","6563","6841","6849","6851","6859","6861","6869","6871","6879","8606")

    pkg.env$pc_malignancy <- c("0010","9925")

    pkg.env$pc_tech_dep <- c("0221","0222","0231","0232","0233","0234","0235","0239","0241","0242","0293","0371",
    ...
    pkg.env$pc_transplant <- c("3751","3350","3351","3352","336", "5561","5569","4697","5051","5059","5280","5282",
      "5283","5284","5285","5286","4100","4101","4102","4103","4104","4105","4106","4107","4108",
      "4109","4194","0091","0092","0093")
  }
  else if (icd_ver == 10) {
    pkg.env$dx_neuromusc <- c("E750","E751","E752","E754","F71","F72","F73","F842","G111","G112","G114","G118",
    ...
    pkg.env$dx_cvd <- c("I270","I271","I272","I2781","I2789","I279","I340","I348","I360","I368","I370",
    ...
    pkg.env$dx_respiratory <- c("E84","G4753","I2782","I43","Q30","Q31","Q32","Q33","Q34","P280","Z902","J84112",
      "J9500","J9501","J9502","J9503","J9504","J9509","9620","Z430","Z930","Z942","Z990","J95850",
      "Z9911","Z9912","T86810","T86811","T86819")

    pkg.env$dx_renal <- c("N18","Q60","Q61","Q62","Q63","Q64","Z905","Z906","G834","N312","N319","T8571XA",
      "Z940","Z9350","Z9351","Z9352","Z9359","Z936","Z9115","Z992","Z435","Z436","Z446","Z4901",
      "Z4902","Z4931","Z4932","T8610","T8611","T8612")

    pkg.env$dx_gi <- c("K50","K51","K73","K74","K754","K760","K761","K762","K763","K768","Q390","Q391",
    ...
    pkg.env$dx_hemato_immu <- c("B20", "D55","D56","D57","D58","D60","D61","D71","D720","D80","D81","D82",
    ...
    pkg.env$dx_metabolic <- c("D841","E700","E702","E703","E704","E705","E708","E710","E711","E712","E713",
    ...
    pkg.env$dx_congeni_genetic <- c("E343","K449","M410","M412","M4130","M418","M419","M4330","M965","Q722","Q750",
    ...
    pkg.env$dx_malignancy <- c("C","D00","D01","D02","D03","D04","D05","D06","D07","D08","D09","D37","D38",
      "D39","D3A0","D40","D41","D42","D43","D44","D45","D46","D47","D48","D49","Q850","Z9481",
      "Z9484","T8600","T8601","T8602","T8609")

    pkg.env$dx_neonatal <- c("P0501","P0511","P0502","P0512","P052","P059","P0701","P0702","P0721","P0722",
    ...
    pkg.env$dx_tech_dep <- c("T8509XA","T85190A","T85192A","T85199A","T8579XA","Z982","Z45441","Z45442","T82519A",
    ...
    pkg.env$dx_transplant <- c("T8600","T8601","T8602","T8609","T8610","T8611","T8612","T8620","T8621","T8622",
      "T86810","T86811","T86819","T8640","T8641","T8642","T86890","T86891","T86899","T86850",
      "T86851","T86859","T865","T8690","T8691","T8692","T8699")

    pkg.env$pc_neuromusc <- c("0016070","0016071","0016072","0016073","0016074","0016075","0016076","0016077",
    ...
    pkg.env$pc_cvd <- c("02170ZP","02170ZQ","02170ZR","02BK0ZZ","02H40JZ","02H40KZ","02H43JZ","02H44JZ",
    ...
    pkg.env$pc_respiratory <- c("0B110F4","0B110Z4","0B113F4","0B113Z4","0B114F4","0B114Z4","0B21XFZ","0BHR0MZ",
    ...
    pkg.env$pc_renal <- c("031209D","031209F","03120AD","03120AF","03120JD","03120JF","03120KD","03120KF",
    ...
    pkg.env$pc_gi <- c("0CT70ZZ","0CT7XZZ","0D11074","0D110J4","0D110K4","0D110Z4","0D113J4","0D11474",
    ...
    pkg.env$pc_hemato_immu <- c("07TP0ZZ","07TP4ZZ","07YP0Z0","07YP0Z1","07YP0Z2","30230AZ","30230G0","30230G1",
    ...
    pkg.env$pc_metabolic <- c("0GT00ZZ","0GT04ZZ","0GT40ZZ","0GT44ZZ","0GTK0ZZ","0GTK4ZZ","0GTR0ZZ","0GTR4ZZ",
    ...
    pkg.env$pc_malignancy <- c("3E00X05","3E01305","3E02305","3E03005","3E03305","3E04005","3E04305","3E05005",
    ...
    pkg.env$pc_tech_dep <- c("00160J0","00160J1","00160J2","00160J4","00160J5","00160J6","00160J7","00160J8",
    ...
    pkg.env$pc_transplant <- c("02YA0Z0","02YA0Z1","02YA0Z2","0BYC0Z0","0BYC0Z1","0BYC0Z2","0BYD0Z0","0BYD0Z1",
    ...
    stop('ICD code set version must be either 9 or 10')
  }
}